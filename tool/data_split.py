...
if __name__ == '__main__':
    ...
    for train_index,test_index in skf.split(X,y):
        ...
        #print(train)
        train.to_csv('/home/2021/xiaohui/Storage/Project_code/label_8fold/Train_fold_{}.csv'.format(str(i)))
        test.to_csv('/home/2021/xiaohui/Storage/Project_code/label_8fold/Val_fold_{}.csv'.format(str(i)))