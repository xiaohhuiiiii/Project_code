...
if __name__ == '__main__':
    csv_file ='/home/2021/xiaohui/Storage/Project_code/label/Label.csv'
    ...
    for train_index,test_index in skf.split(X,y):
        ...
        #print(train)
        train.to_csv('/home/2021/xiaohui/Storage/Project_code/label/Train_fold_{}.csv'.format(str(i)))
        test.to_csv('/home/2021/xiaohui/Storage/Project_code/label/Test_fold_{}.csv'.format(str(i)))